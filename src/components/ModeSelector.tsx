...
export function ModeSelector({ mode, onModeChange }: ModeSelectorProps) {
  return (
    <div className="mode-selector">
      <button
        className={`mode-option ${mode === "aws" ? "mode-option-active" : ""}`}
        onClick={() => onModeChange("aws")}
      >
